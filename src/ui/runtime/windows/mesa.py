...
from ui.runtime.vulkan import (
    VulkanDeviceKind,
    list_vulkan_devices,
    parse_vulkan_device_selector,
)
from ui.runtime.windows.vulkan import mesa_directory, vulkan_driver_manifest
...
def register_opengl_platform() -> None:
    if sys.platform == "win32" and os.environ.get("PYOPENGL_PLATFORM") == "pu6e_mesa":
        ...
        PlatformPlugin("pu6e_mesa", "ui.runtime.windows.opengl.MesaPlatform")
